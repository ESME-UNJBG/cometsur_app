...
import ComputadoraModal from "..//accesos/comp_Ac"; // 👈 importar el nuevo modal
import CelularModal from "../accesos/cel_Ac";
interface AcProps {
  onClose: () => void;
}

const Ac: React.FC<AcProps> = ({ onClose }) => {
        ...
        <div className="card-body">
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div style={{ width: "33%", textAlign: "center" }}>
              <p className="m-0 fw-bold">Actulizar</p>
            </div>
